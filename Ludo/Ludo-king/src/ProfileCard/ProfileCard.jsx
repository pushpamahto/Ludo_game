...
const ProfileCard = () => {
  ...
  const sections = [
    ...
    { id: "delete", label: "🗑️ Delete Account" }, // New section for Delete Account
  ...
  const handleDeleteAccount = () => {
    ...
    if (confirmDelete) {
      ...
      // Add logic to delete the account (e.g., API call)
    }
  };
      ...
      <div className="profile-wrapper">
        ...
        <div className="main-content">
          ...
          {activeSection === "logout" && (
            <div className="content-section active">
              <div className="wallet-card">
                <h2 className="text-[#e94560] text-4px font-bold mb-2">Logout</h2>
          ...
          {activeSection === "delete" && (
            <div className="content-section active">
              <div className="wallet-card">
                <h2 className="text-[#e94560] text-4px font-bold mb-2">Delete Account</h2>
                <p>Are you sure you want to delete your account? This action cannot be undone.</p>
                <button onClick={handleDeleteAccount} className="nav-btn">
                  Delete Account
                </button>
              </div>
            </div>
