...
const Playzone = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Check if the click is outside the image card and options container
      if (
        !event.target.closest(".image-card-container") &&
