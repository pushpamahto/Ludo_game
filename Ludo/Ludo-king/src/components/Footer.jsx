...
//   return (
//     <div className="mt-6 flex flex-col justify-end pb-4">
...
//         <NavItem
//           icon={<HomeIcon style={{ fontSize: "30px" }} className="cursor-pointer" onClick={() => navigate("/login")} />} 
//           label="Home"
//           active={active === "home"}
...
//         <NavItem
//           icon={<SportsEsportsIcon style={{ fontSize: "30px" }} className="cursor-pointer" onClick={() => navigate("/login")} />}
//           label="Playzone"
...
//         <NavItem
//           icon={<GroupIcon style={{ fontSize: "30px" }} className="cursor-pointer" />}
//           label="Friends"
...
//         <NavItem
//           icon={<AccountCircleIcon style={{ fontSize: "27px" }} className="cursor-pointer" />}
//           label="Profile"
...
const Footer = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-end pb-4">
      <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 bg-gradient-to-br from-[#0f3460] to-[#1a1a2e] bg-opacity-70 shadow-lg rounded-t-xl w-full flex justify-around p-2">
        <NavItem
